...
export const AbgAnalyzer = ({ values, setValues, patientDetails, setPatientDetails }: AbgAnalyzerProps) => {
  ...
  const handleDownloadTxt = () => {
    ...
    reportLines.push(``, `DISCLAIMER`, `----------`, `This is an automated analysis and is not a substitute for clinical judgment. All results must be correlated with the patient's clinical condition by a qualified healthcare professional.`, ``, `Report generated by https://abgpro.vercel.app`);
          ...
          <Card className="w-full bg-white dark:bg-gray-800 shadow-custom border rounded-xl">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 pt-4 border-t">
                ...
                <div className="space-y-4">
                  <SectionHeader icon={<FlaskConical className="h-5 w-5 text-purple-500" />} title="Anion Gap" />
                  <div>
