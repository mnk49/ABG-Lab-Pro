          ...
          <Card className="w-full bg-white dark:bg-gray-800 shadow-custom border rounded-xl">
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1"><label htmlFor="ph" className="text-sm font-medium text-gray-600 dark:text-gray-300">pH (7.35-7.45)</label></div>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1"><label htmlFor="paco2" className="text-sm font-medium text-gray-600 dark:text-gray-300">PaCO₂ (35-45 mmHg)</label></div>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1"><label htmlFor="hco3" className="text-sm font-medium text-gray-600 dark:text-gray-300">HCO₃⁻ (22-26 mEq/L)</label></div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1"><label htmlFor="pao2" className="text-sm font-medium text-gray-600 dark:text-gray-300">PaO₂ (80-100 mmHg)</label></div>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1"><label htmlFor="fio2" className="text-sm font-medium text-gray-600 dark:text-gray-300">FiO₂ (0.21-1.0)</label></div>
